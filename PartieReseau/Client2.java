...
public class Client2  { 
    ...
    public static void main(String[] args) throws IOException  { 
        try { 
            ...
            System.out.println("IP address ? (nothing + enter = localhost)");
            ...
            while (true)  { 
                ...
                System.out.println(name+"> "+sendToServer);
                 
                // If the client (you) sends "end" => Close the connection
                if(sendToServer.equals("end")) { 
                    System.out.println(name+"> Closing this connection...."); 
                    sock.close(); 
            ...
            System.out.println("Can't reach server...Check Ip/port and connectivity");
        }
